...
setwd("C:/Users/sshek/Documents/My Documents/Spring 2019 Courses/ALDA/Homeworks/HW1/HW1_p7")
# read data matrix
...
analyze_normalization <- function(data_matrix, normalized_data_matrix){
  ...
  # Write code here to generate the output requested as well as any plots/analyses requested.
	...
	plot_distance_matrix(euclid_norm_matrix)
	plot_distance_matrix(euclid_orig_matrix)
}
